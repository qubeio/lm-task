...
The user will be able to define 2 separate roles (can be the same provider or separate providers) for main AI operations, and a fallback model in case of errors.
...
> Can you show me the details of my tasks?
