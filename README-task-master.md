...
### by [Andreas Frangopoulos](https://github.com/qubeio)

A task management system for AI-driven development with AI Agents, designed to work seamlessly with Cursor AI.
...
```bash
task-master add-subtask --parent=5 --title="Implement feature"
```
...
```bash
task-master add-subtask --parent=5 --title="Security implementation" --description="Focus on security aspects"
```

You can also add subtasks to multiple tasks manually as needed.

For adding subtasks with research context, you can provide detailed descriptions when using the add-subtask command.
