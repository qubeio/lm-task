...
export function registerParsePRDTool(server) {
  server.addTool({
    name: "parse_prd",
    description:
      "Parse a Product Requirements Document (PRD) text file to automatically generate initial tasks. Reinitializing the project is not necessary to run this tool. It is recommended to run parse-prd after initializing the project and creating/importing a PRD file (PRD.md, prd.md, PRD.txt, or prd.txt) in the project root or scripts/ directory.",
    parameters: z.object({
      input: z
        .string()
        .optional()
