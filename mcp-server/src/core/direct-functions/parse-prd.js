...
import { findPRDDocumentPath } from "../utils/path-utils.js";
...
export async function parsePRDDirect(args, log, context = {}) {
  ...
  let inputPath;
  if (!inputArg) {
    // No input provided, search for PRD files using findPRDDocumentPath
    logWrapper.info("No input path provided, searching for PRD files...");
    inputPath = findPRDDocumentPath(projectRoot, null, logWrapper);
    ...
    logWrapper.info(`Found PRD file at: ${inputPath}`);
  } else {
    // Input provided, resolve it relative to projectRoot
