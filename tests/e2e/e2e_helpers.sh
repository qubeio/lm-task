...
analyze_log_with_llm() {
  ...
  local api_key_name="AZURE_OPENAI_API_KEY"
  local llm_analysis_model_id="gpt-4o" # Model used for this analysis
  local llm_analysis_provider="azure"
...
EOF
  ...
  local api_endpoint="${azure_endpoint}/openai/deployments/${llm_analysis_model_id}/chat/completions?api-version=2024-08-01-preview"
