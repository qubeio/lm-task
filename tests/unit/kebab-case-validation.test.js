...
describe("Kebab Case Validation", () => {
  describe("toKebabCase", () => {
    test("should convert camelCase to kebab-case", () => {
      expect(toKebabCase("titleText")).toBe("title-text");
  ...
  describe("detectCamelCaseFlags", () => {
    ...
    test("should handle mixed case flags correctly", () => {
      const args = [
        ...
        "lm-tasker",
        "add-task",
        "--title=test", // single word, should pass
        "--titleText=test", // camelCase, should flag
        "--title-text=test", // kebab-case, should pass
