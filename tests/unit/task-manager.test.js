...
// Removed mockCreate and mockChatCompletionsCreate - no longer needed with Azure-only deployment
...
// Mock Perplexity using OpenAI - Also removed as we don't support research anymore
// jest.mock('openai', () => { ... });
            ...
            next: jest
              ...
              .mockResolvedValueOnce({
                ...
                value: {
                  type: "content_block_delta",
                  delta: {
                    text: '{"id": 3, "title": "Updated UI Components",',
                  },
                },
              })
              .mockResolvedValueOnce({
